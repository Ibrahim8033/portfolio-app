...
export function CodePortfolio() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-black text-slate-200 font-mono p-8">
      <div className="max-w-5xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-1 space-y-6">
            ...
            {/* Platformes */}
            <div>
              <span className="text-cyan-400">public enum</span> <span className="text-yellow-400">PLATFORMES</span>
            ...
            {/* Langages */}
            <div>
              <span className="text-cyan-400">public enum</span> <span className="text-yellow-400">LANGAGES</span>
              <span className="text-slate-400">()</span>
              <div className="ml-4 mt-2">
                <span className="text-slate-400">{'{'}</span>
            ...
            {/* Logiciels */}
            <div>
              <span className="text-cyan-400">public enum</span> <span className="text-yellow-400">LOGICIELS</span>
              <span className="text-slate-400">()</span>
              <div className="ml-4 mt-2">
                <span className="text-slate-400">{'{'}</span>
                <div className="ml-4 space-y-1 text-sm">
            ...
            {/* Media */}
            <div>
              <span className="text-cyan-400">public enum</span> <span className="text-yellow-400">MEDIA</span>
              <span className="text-slate-400">()</span>
              <div className="ml-4 mt-2">
                <span className="text-slate-400">{'{'}</span>
                <div className="ml-4 space-y-1 text-sm">
            ...
            {/* Langues */}
            <div>
              <span className="text-cyan-400">public enum</span> <span className="text-yellow-400">LANGUES</span>
              <span className="text-slate-400">()</span>
              <div className="ml-4 mt-2">
                <span className="text-slate-400">{'{'}</span>
                <div className="ml-4 space-y-1 text-sm">
            ...
            {/* Profilo */}
            <div>
              <span className="text-cyan-400">public enum</span> <span className="text-yellow-400">PROFILO</span>
              <span className="text-slate-400">()</span>
              <div className="ml-4 mt-2">
                <span className="text-slate-400">{'{'}</span>
                <div className="ml-4 space-y-1 text-sm">
          ...
          <div className="md:col-span-2 space-y-12 overflow-y-auto max-h-screen pr-4">
            ...
            <div className="space-y-2">
              ...
              <div className="mt-2">
                <span className="text-cyan-400">public class</span> <span className="text-yellow-400">INFORMATION</span>
              </div>
              <div className="text-slate-400">{'{'}</div>

              <div className="ml-4 space-y-2">
                <div>
                  <span className="text-cyan-400">public string</span> <span className="text-yellow-400">NAME</span>
                  <span className="text-slate-400"> = </span>
                ...
                <div>
                  <span className="text-cyan-400">public string</span> <span className="text-yellow-400">TITLE</span>
                  <span className="text-slate-400"> = </span>
                ...
                <div>
                  <span className="text-cyan-400">public string</span> <span className="text-yellow-400">EMAIL</span>
                  <span className="text-slate-400"> = </span>
                ...
                <div>
                  <span className="text-cyan-400">public string</span> <span className="text-yellow-400">PHONE</span>
                  <span className="text-slate-400"> = </span>
                ...
                <div>
                  <span className="text-cyan-400">public string</span> <span className="text-yellow-400">POSITION</span>
                  <span className="text-slate-400"> = </span>
                ...
                <div>
                  <span className="text-cyan-400">public int</span> <span className="text-yellow-400">AGE</span>
                  <span className="text-slate-400"> = </span>
                ...
                <div>
                  <span className="text-cyan-400">public string</span> <span className="text-yellow-400">LOCATION</span>
                  <span className="text-slate-400"> = </span>
            ...
            <div className="space-y-2">
              ...
              <div className="mt-2">
                <span className="text-cyan-400">public partial class</span> <span className="text-yellow-400">FORMATIONS</span>
                <span className="text-slate-400"> : </span>
              ...
              <div className="ml-4 space-y-4">
                <div>
                  <span className="text-cyan-400">private void</span> <span className="text-yellow-400">Bachelor</span>
                  <span className="text-slate-400">()</span>
                </div>
                <div className="text-slate-400">{'{'}</div>
                <div className="ml-4 space-y-1">
            ...
            <div className="space-y-2">
              ...
              <div className="mt-2">
                <span className="text-cyan-400">public static class</span> <span className="text-yellow-400">EXPERIENCES</span>
              </div>
              <div className="text-slate-400">{'{'}</div>

              <div className="ml-4 space-y-4">
                <div>
                  <span className="text-cyan-400">public void</span> <span className="text-yellow-400">ProjectOne</span>
                  <span className="text-slate-400">()</span>
                </div>
                <div className="text-slate-400">{'{'}</div>
                <div className="ml-4 space-y-1 text-sm">
                  ...
                  <div>
                    ...
                    <span className="text-slate-400"> = </span>
                    <span className="text-cyan-400">new</span> <span className="text-yellow-400">Project</span>
                    <span className="text-slate-400">();</span>
                  </div>
                </div>
                <div className="text-slate-400">{'}'}</div>
                ...
                <div>
                  <span className="text-cyan-400">public void</span> <span className="text-yellow-400">ProjectTwo</span>
                  <span className="text-slate-400">()</span>
                </div>
                <div className="text-slate-400">{'{'}</div>
                <div className="ml-4 space-y-1 text-sm">
                ...
                <div>
                  <span className="text-cyan-400">public void</span> <span className="text-yellow-400">ProjectThree</span>
                  <span className="text-slate-400">()</span>
                </div>
                <div className="text-slate-400">{'{'}</div>
                <div className="ml-4 space-y-1 text-sm">
